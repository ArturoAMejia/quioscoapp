...
const ResumenProducto = ({ producto }) => {
  ...
  return (
    <div className="shadow-sm pb-5 mb-3 flex gap-10 items-center">
      ...
      <div>
        <button
          type="button"
          className="bg-sky-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold shadow-md w-full"
        ...
        <button
          type="button"
          className="bg-red-700 flex gap-2 px-5 py-2 mt-2 text-white rounded-md font-bold shadow-md w-full"
